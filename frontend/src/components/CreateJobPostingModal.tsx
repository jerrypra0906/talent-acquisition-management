...
export default function CreateJobPostingModal({ isOpen, onClose, onSave, editingJobPosting }: CreateJobPostingModalProps) {
  ...
  useEffect(() => {
    if (editingJobPosting && isOpen) {
      setFormData({
        ...
        employmentType: editingJobPosting.type === 'contract' ? 'Kontrak' : editingJobPosting.type === 'full-time' ? 'Probation' : '',
        typeGrade: editingJobPosting.level || '',
        grade2: editingJobPosting.grade2 || '',
        ...
        totalRequest: editingJobPosting.totalRequest || '',
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const requiredFields = ['pt', 'division', 'section', 'hiringManager', 'position', 'employmentType', 'criteria', 'area', 'areaDetail', 'additionalOrReplacement', 'totalRequest', 'requestDate', 'jobSpecification']
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            {editingJobPosting ? 'Edit Open Position' : 'Create New Open Position'}
          </h2>
          <button
            onClick={handleClose}
            style={{
