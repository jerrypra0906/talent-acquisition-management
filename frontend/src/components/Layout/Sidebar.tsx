...
const baseNavigation = [
  ...
  { name: 'Open Position', href: '/fptk', icon: BriefcaseIcon },
...
export default function Sidebar({ sidebarOpen, setSidebarOpen }: SidebarProps) {
  ...
  // Menu Access config (prototype): localStorage 'menuAccess' or defaults
  const menuAccess = (() => {
    try { return JSON.parse(localStorage.getItem('menuAccess') || 'null') || {} } catch { return {} }
  })()
